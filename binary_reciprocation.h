//VAMOS CRIAR UM PROGRAMA QUE IMPLEMENTA O CÁLCULO DO RECÍPROCO GENERALIZADO DE UM INTEIRO DE 128 BITS E APLICAÇÕES PARA ARITMÉTICA MODULAR
//ESSE ALGORITMO DE DIVISÃO E ARITMÉTICA MODULAR É UMA VERSÃO DO ALGORITMO DE BARRET PARA INTEIROS DE 128 BITS.
...
void binary_modular_division_algorithm(__int128_t*, __int128_t*, __int128_t, __int128_t);

//****************************************************************************************************************************************
//FUNÇÕES 
//Função que computa o número de bits na string binária de um inteiro de 128 bits
...
//Função que retorna a relação de congruência e limitante inferior do quociente de inteiros de 128 bits usando a redução de Barret
void binary_modular_division_algorithm(__int128_t* quotient, __int128_t* modulus, __int128_t x, __int128_t N){
